            ...
            for c in candidates:
                for normalize in [0, 1]:
                    for is_dev in [True, False]:
                        ...
                        cmd = f"PYTHONPATH=. python3 kbc/query_answer_BF.py --model_path models-distmult/{m}-DistMult-model-rank-{r}-epoch-100-*.pt " \
                        ...
                        cmd_lines += [f"{cmd} > logs/topk-dm/{_id}.log 2>&1"]
