...
def to_cmd(c, _path=None):
    command = f'PYTHONPATH=. python3 -m kbc.learn kbc/data/FB15k-237 --model DistMult --max_epochs {c["e"]} --model_save_schedule 1000 --valid 3 --reg {c["n3"]} --batch_size {c["b"]} --rank {c["k"]}'
    return command
